    ...
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl text-center space-y-8 relative z-10">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance leading-relaxed">
          Join creators who are turning their podcast dreams into reality with GEMCAST's AI-powered team
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <Button size="lg" variant="outline" className="text-base px-8 h-12 glass border-border/50 bg-transparent">
            Schedule a Demo
          </Button>
        </div>
        <div className="pt-4 text-sm text-muted-foreground">No credit card required · Get started in minutes</div>
      </div>
    </section>
  )
}

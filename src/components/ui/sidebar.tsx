...
>(({ className, ...props }, ref) => {
  return (
    <Input
      className={cn(
        'h-8 w-full bg-sidebar text-sidebar-foreground placeholder:text-sidebar-foreground/50 shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring border-sidebar-border',
        className,
      )}
      data-sidebar="input"
      ref={ref}
